...
title: "TPP v0.1 — the Token Pony Protocol specification"
description: "The Token Pony Protocol v0.1 draft specification: discovery, client registration, authorization, token exchange, metered inference, and revocation."
---
