/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eed5414aa873ef719969a4221525d11e)
// Runtime types generated with workerd@1.20260714.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	AI_GATEWAY_ID: "tokenpony";
	POSTAGE_CENTS: "82";
	ISSUER: "https://tokenpony-api.tailb55c1.ts.net" | "https://api.tokenpony.dev";
	MODEL_FILTER?: "@proc/";
	METERING?: "off";
	AUTHGRAVITY_URL: "https://authgravity.tokenpony.dev";
	WWW_URL: "https://tokenpony-www.tailb55c1.ts.net" | "https://tokenpony.dev";
	TAILNET?: Fetcher /* mf-tailnet */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface ProcdevEnv {
		DB: D1Database;
		AI: Ai;
		AI_GATEWAY_ID: "tokenpony";
		POSTAGE_CENTS: "82";
		ISSUER: "https://tokenpony-api.tailb55c1.ts.net";
		MODEL_FILTER: "@proc/";
		METERING: "off";
		AUTHGRAVITY_URL: "https://authgravity.tokenpony.dev";
		WWW_URL: "https://tokenpony-www.tailb55c1.ts.net";
		TAILNET: Fetcher /* mf-tailnet */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "POSTAGE_CENTS" | "ISSUER" | "MODEL_FILTER" | "METERING" | "AUTHGRAVITY_URL" | "WWW_URL">> {}
}
